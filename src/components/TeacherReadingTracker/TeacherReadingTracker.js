...
import styles from './TeacherReadingTracker.module.scss';
...
function TeacherReadingTracker() {
  const gradeOptions = [
    ...
    { value: 'Student4', label: 'Student4' },
    { value: 'Student5', label: 'Student5' },
    { value: 'Student6', label: 'Student6' },
  ];
    ...
    <div className={styles.ReadingTracker}>
      ...
      <div className={styles.scoringContainer}>
        ...
        <div className={styles.targetContainer}>
          <h3 className={styles.targetLabel}>Target %: </h3>
        ...
        <h3 className={styles.onLevelLabel}>
...
export default TeacherReadingTracker;
